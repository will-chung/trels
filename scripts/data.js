class Data {
  ...
  update() {
    ...
    expectedVariance.innerHTML =
      'Expected Variance: ' + this.getExpectedVariance();
    ...
    if (this.roulette.selectedSector) {
      probability.innerHTML =
        'Probability: ' + this.roulette.selectedSector.probability;
    } else probability.innerHTML = 'Probability: 0';
  }
}
